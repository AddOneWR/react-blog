...
const MacNav = () => {
  ...
  const [isProOpen, setProStatus] = useState(false);
  ...
  return (
    <div className="macnav-container">
      <div className="macnav-main">
        ...
        <div className="macnav-link" onClick={() => setLinkStatus(!isLinkOpen)}>友情链接</div>
        <div className="macnav-link" onClick={() => setProStatus(!isProOpen)}>小小实验室</div>
        <ul 
